...
const CompleteProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Insertar nuevo perfil en la tabla ai_profiles
    ...
    <div className="max-w-lg mx-auto p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <input
          name="certificados"
          type="text"
          placeholder="Certificados (separados por coma)"
        ...
        <input
          name="grupos"
          type="text"
          placeholder="Grupos/Clubes (separados por coma)"
          value={form.grupos}
          onChange={handleChange}
          className="w-full p-2 border rounded"
        />
        ...
        <input
          name="proyectos"
          type="text"
          placeholder="Proyectos (separados por coma)"
